...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${ctx}/static/bootstrap-metronic/template_content/assets/plugins/data-tables/DT_bootstrap.css" />
	...
	<script type="text/javascript" src="${ctx}/static/bootstrap-metronic/template_content/assets/plugins/select2/select2_locale_zh-CN.js"></script>
	<script type="text/javascript" src="${ctx}/static/jquery-highstock/highstock.src.js"></script>
	<script type="text/javascript" src="${ctx}/static/jquery-highstock/modules/exporting.js"></script>
	<script type="text/javascript" src="${ctx}/static/bootstrap-metronic/template_content/assets/plugins/data-tables/jquery.dataTables.js"></script>
	<script type="text/javascript" src="${ctx}/static/bootstrap-metronic/template_content/assets/plugins/data-tables/DT_bootstrap.js"></script>
	<!-- END CORE PLUGINS -->
	<sitemesh:head/>
</head>
<!-- END HEAD -->
...
<body class="page-header-fixed">
	...
	<script src="${ctx}/static/bootstrap-metronic/template_content/assets/plugins/bootstrap-modal/js/bootstrap-modalmanager.js" 
	type="text/javascript"></script>
	<script src="${ctx}/static/bootstrap-metronic/template_content/assets/plugins/bootstrap-modal/js/bootstrap-modal.js" 
	type="text/javascript"></script>
	...
	<script src="${ctx}/static/common/js/menu.js" type="text/javascript"></script>
