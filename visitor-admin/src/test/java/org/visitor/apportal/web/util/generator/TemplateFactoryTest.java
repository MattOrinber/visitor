...
import org.visitor.apportal.web.util.generator.db.SqlTable;
import org.visitor.apportal.web.util.generator.template.TemplateFactory;
...
public class TemplateFactoryTest {
	...
	private String tablename = "web_test";
	...
	public void testTemplateFactoryForMybatis() throws IOException,
			TemplateException {
		TemplateFactory factory = TemplateFactory.getInstance();
		String path = "templates/Mybatis.java.ftl";
