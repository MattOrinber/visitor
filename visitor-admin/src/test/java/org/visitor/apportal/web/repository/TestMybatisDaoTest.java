...
public class TestMybatisDaoTest extends SpringTransactionalTestCase {
    ...
    private static List<org.visitor.apportal.web.entity.Test> testList = Lists.newArrayList();

    @BeforeClass
    public static void setUpClass() {
        for (int i = 0; i < 10; i++) {
            org.visitor.apportal.web.entity.Test test = new org.visitor.apportal.web.entity.Test();
            test.setMsg("" + i);
            testList.add(test);
        }
    }
    ...
    public void testTest() {
        org.visitor.apportal.web.entity.Test test = dao.getTestById(1);
    ...
    public void testInsertBatch() {
        ...
        int beforeInsertCount = countRowsInTable("web_test");

        dao.insertBatch(testList);

        int afterInsertCount = countRowsInTable("web_test");
    ...
    public void testBuildPage() {
        ...
        List<org.visitor.apportal.web.entity.Test> tests = dao.find(filterParams, new RowBounds(
                (pageNumber - 1) * pageSize, pageSize));
        int totalnum = dao.findTotalNum(filterParams);

        Page<org.visitor.apportal.web.entity.Test> pageTest = new PageImpl<org.visitor.apportal.web.entity.Test>(
