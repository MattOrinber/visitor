...
INSERT INTO `web_menu` (`id`,`parent_id`,`parent_ids`,`name`,`href`,`sort`,`is_show`,`permission`) VALUES 
 (1,0,'0,','顶级菜单',NULL,0,'1',NULL),
 (2,1,'0,1,','测试菜单','',0,'1',''),
 (3,2,'0,1,2,','测试','/test',0,'1','');

 INSERT INTO `web_role` (`id`,`name`,`detail`) VALUES 
 (1,'admin','超级管理员'),
 (2,'user','普通用户');
...
INSERT INTO `web_user` (`id`,`login_name`,`name`,`password`,`salt`,`email`,`status`,`staff_no`,`phone`,`mobile`) VALUES 
...
INSERT INTO `web_test` (`id`,`msg`) VALUES (1,'test');