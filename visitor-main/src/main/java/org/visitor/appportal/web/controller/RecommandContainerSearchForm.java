...
public class RecommandContainerSearchForm extends SearchForm<RecommandContainer> implements Serializable {
    private static final long serialVersionUID = 1L;
    private RecommandContainer recommandContainer = new RecommandContainer();

    /**
     * The RecommandContainer instance used as an example.
     */
    public RecommandContainer getRecommandContainer() {
	...
	@Override
	public Specification<RecommandContainer> toSpecification() {
