...
public class TemplateSearchForm extends SearchForm<Template> implements Serializable {
    private static final long serialVersionUID = 1L;
    private Template template = new Template();

    /**
     * The Template instance used as an example.
     */
	...
	/* (non-Javadoc)
	 * @see org.visitor.appportal.web.utils.SearchForm#toSpecification()
	 */
	@Override
	public Specification<Template> toSpecification() {
