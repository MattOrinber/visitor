package org.visitor.appportal.context;
...
public class AccountContext {
    ...
    /**
     * Bind the passed site to this site context.
     */
    ...
    /**
     * Return the {@link Site} instance bound to the current thread, if any.
     *
     * @return the current site, or <code>null</code> if none.
     */
    public Site getSite() {
        return site;
    }
