...
<a id="${model}_${attribute}" class="navigation" href="${url}"><fmt:message key="${model}_${attribute}"/><c:if test="${param['sp.sortColumnKey'] == attribute}"><span class="ui-icon ui-icon-arrow-1-${param['sp.sortOrder'] == 'ascending' ? 'n' : 's'}" style="float:right""></span></c:if></a>
